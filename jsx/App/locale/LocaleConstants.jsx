...
export const navBarIndexText = {
  ...
  //[FRANCAIS]: "Index des Textes",
	[KANIENKEHA]: "Index of Texts", // Need Kanien'kéha translation
};
...
export const searchPagePromptText = {
  ...
  //[FRANCAIS] : "Rechercher dans la base de données:",
	[KANIENKEHA] : "Search database:", // Need Kanien'kéha translation
};
...
export const searchPageNextButtonText = {
  ...
  //[FRANCAIS] : "Page suivante",
	[KANIENKEHA] : "Next page", // Need Kanien'kéha translation
};
...
export const searchPagePrevButtonText = {
  ...
  //[FRANCAIS] : "Page précédente",
	[KANIENKEHA] : "Previous page", // Need Kanien'kéha translation
};
...
export const indexPageMediaHeaderText = {
  ...
  //[ESPANOL] : "Medios",
  //[FRANCAIS] : "Médias",
	[KANIENKEHA] : "Media", // Need Kanien'kéha translation
};
...
export const notFoundPageText = {
  ...
  //[FRANCAIS] : "Histoire introuvable. Peut-être avez-vous mal saisi l'URL?",
	[KANIENKEHA] : "Story not found. Perhaps you mistyped the URL?", // Need Kanien'kéha translation
};
...
export const loadingPageText = {
  ...
  //[ESPANOL] : "Cargando...",
  //[FRANCAIS] : "Chargement...",
	[KANIENKEHA] : "Loading...", // Need Kanien'kéha translation
};
...
export const showOrHideTiersButtonText = {
  ...
  //[FRANCAIS] : "Afficher/masquer les niveaux",
	[KANIENKEHA] : "Kawennakwe'ní:io's", // Consider replacing with suggestion from Nov 24 doc
};
...
export const metadataDateText = {
  ...
  //[ESPANOL] : "Fecha",
  //[FRANCAIS] : "Date",
	[KANIENKEHA] : "Date", // Need Kanien'kéha translation
};
...
export const metadataGenreText = {
  ...
  //[ESPANOL] : "Género",
  //[FRANCAIS] : "Genre",
	[KANIENKEHA] : "Genre", // Need Kanien'kéha translation
};
...
export const metadataGlosserText = {
  ...
  //[ESPANOL] : "Glosador",
  //[FRANCAIS] : "Glosser",
	[KANIENKEHA] : "Glosser", // Need Kanien'kéha translation
};
...
export const metadataSourceText = {
  ...
  //[ESPANOL] : "Fuente",
  //[FRANCAIS] : "Source",
	[KANIENKEHA] : "Source", // Need Kanien'kéha translation
};
...
export const storySearchViewStoryText = {
  ...
  //[FRANCAIS] : "Voir l'histoire",
	[KANIENKEHA] : "Oká:ra", // Follow up on Kanien'kéha translation
};
...
export const latexSelectTiersPromptText = {
  ...
  //[FRANCAIS] : "Veuillez sélectionner le niveau à utiliser pour chaque ligne du gloss LaTeX.",
	[KANIENKEHA] : "Please select what tier to use for each line in the LaTeX gloss.", // Follow up on Kanien'kéha translation
};
...
export const latexSentenceTierName = {
	...
	[KANIENKEHA] : "Kanien'kéha", // Follow up on Kanien'kéha translation
};
...
export const latexMorphemesTierName = {
	...
	//[ESPANOL] : "morfemas",
	//[FRANCAIS] : "morphèmes",
	[KANIENKEHA] : "morphemes", // Follow up on Kanien'kéha translation
};
...
export const latexMorphemeTranslationsTierName = {
	...
	[KANIENKEHA] : "tekawennakhahsiónkwen",
};
...
export const tierSelectionConfirmButtonText = {
  ...
  //[ESPANOL] : "Confirmar",
  //[FRANCAIS] : "Confirmer",
	[KANIENKEHA] : "Confirm", // Need Kanien'kéha translation
};
...
export const latexCloseButtonText = {
  ...
  //[ESPANOL] : "Cerrar",
  //[FRANCAIS] : "Fermer",
	[KANIENKEHA] : "Close", // Need Kanien'kéha translation
};
...
export const latexStoryIDText = {
  ...
  //[FRANCAIS] : "ID de l'histoire:",
	[KANIENKEHA] : "Story ID: ", // Need Kanien'kéha translation
};
...
export const latexSentenceURLText = {
  ...
  //[FRANCAIS] : "URL de la phrase:",
	[KANIENKEHA] : "URL: ", // Need Kanien'kéha translation
};
...
export const latexLibraryText = {
  ...
  //[FRANCAIS] : "Formaté pour les packages LaTeX gb4e et gb4e-modified:",
	[KANIENKEHA] : "Formatted for gb4e and gb4e-modified LaTeX packages:", // Need Kanien'kéha translation
};

export const footerText = {
  [ENGLISH]: "The latest update to this LingView website was in May 2026. This website is powered by ",
  //[ESPANOL]: "Este sitio web funciona con ",
  //[FRANCAIS]: "Ce site Web est alimenté par ",
	[KANIENKEHA]: "The latest update to this LingView website was in May 2026. This website is powered by ", // Need Kanien'kéha translation
};
